...
from .views_api import (
    ...
    ClinicCommentBundleListCreateView,
    ClinicMessageLogListCreateView,
    ClinicNoticeListCreateView,
    ClinicNoticeDetailView,
    ClinicNoticeReadView,
    GlobalNoticeListCreateView,
    GlobalNoticeDetailView,
    GlobalNoticeReadView,
...
urlpatterns = [
    ...
    path("clinics/<int:clinic_id>/comment-bundles/", ClinicCommentBundleListCreateView.as_view()),
    path("clinics/<int:clinic_id>/message-logs/", ClinicMessageLogListCreateView.as_view()),
    path("clinics/<int:clinic_id>/notices/", ClinicNoticeListCreateView.as_view()),
    path("clinics/<int:clinic_id>/notices/<int:notice_id>/", ClinicNoticeDetailView.as_view()),
    path("clinics/<int:clinic_id>/notices/<int:notice_id>/read/", ClinicNoticeReadView.as_view()),
    path("global-notices/", GlobalNoticeListCreateView.as_view()),
    path("global-notices/<int:notice_id>/", GlobalNoticeDetailView.as_view()),
    path("global-notices/<int:notice_id>/read/", GlobalNoticeReadView.as_view()),
